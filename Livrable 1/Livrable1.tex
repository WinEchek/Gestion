...
Jouer une partie
 \begin{itemize}
  \item {\textcolor{orange}{Moyenne}} Jouer en réseau
  \begin{itemize}
   \item {\textcolor{orange}{Moyenne}} Rejoindre une partie
   \begin{itemize}
    \item {\textcolor{orange}{Moyenne}} Rechercher une partie
   \end{itemize}
   \item {\textcolor{orange}{Moyenne}} Héberger une partie
  \end{itemize}
  \item {\textcolor{green}{Basse}} Jouer contre une IA
  \begin{itemize}
   \item {\textcolor{green}{Basse}} Sélectionner le niveau de difficulté
  \end{itemize}
  \item {\textcolor{red}{Haute}} Jouer sur la même machine
  \begin{itemize}
   \item {\textcolor{red}{Haute}} Afficher quel joueur doit jouer
  \end{itemize}
  \item {\textcolor{orange}{Moyenne}} Gérer la partie
  \begin{itemize}
  ...
  \end{itemize}
  \item {\textcolor{red}{Haute}} Jouer un tour
  \begin{itemize}
