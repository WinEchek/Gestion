...
L'utilisateur demande à annulé le dernier coup effectué, l'annulation est transmise au moteur via la partie. Celui-ci annulera le coup dans le modèle et en informe la partie.
